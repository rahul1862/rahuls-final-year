...
// Local to this form only — just enough to show the right symbol next to the
// price field. The buyer-facing currency conversion happens at checkout, not here.
                ...
                {submitted ? (
                  ...
                  >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                      ...
                      {/* Image URL — drag-and-drop upload isn't built yet, so this is a
                          direct-link field rather than a fake uploader that doesn't do anything. */}
                      <div>
                        <label className="flex items-center gap-1.5 text-sm text-[#71717a] mb-1.5">
